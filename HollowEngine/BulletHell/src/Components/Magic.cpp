...
namespace BulletHell
{
	...
	std::unordered_map<int, Magic::SpellData*> Magic::CreateBasicSpellMap()
	{
		...
		Magic::SpellData* pBasicSpell = new Magic::SpellData{ "Fire", "Spells/Fire", FIRE, 1.570796f, 0.0f, "Resources/Textures/fire.png", 0.5f, glm::vec3(0.6, 0.0, 0.0)};
		spellMap.emplace(SpellType::FIRE, pBasicSpell);

		pBasicSpell = new Magic::SpellData{ "Air", "Spells/Air", AIR, 3.14159f, 0.0f, "Resources/Textures/cracks.png", 0.5f, glm::vec3(0.4, 0.4, 0.4)};
		spellMap.emplace(SpellType::AIR, pBasicSpell);

		pBasicSpell = new Magic::SpellData{ "Earth", "Spells/Earth", EARTH, 0.0f, 0.0f, "Resources/Textures/rocks.png" , 1.0f, glm::vec3(0.4, 0.2, 0.0)};
		spellMap.emplace(SpellType::EARTH, pBasicSpell);

		pBasicSpell = new Magic::SpellData{ "Water", "Spells/Water", WATER, 4.712388f, 0.0f, "Resources/Textures/water.png" , 0.75f, glm::vec3(0.1, 0.1, 0.7)};
	...
	{
		std::unordered_map<int, Magic::SpellData*> spellMap;
		Magic::SpellData* pCombinedSpell = new Magic::SpellData{ "Fire + Fire", "Spells/FireFire", COMBINED,  0.0f, 0.0f, "", 3.0f, glm::vec3(0.0f), "Resources/Textures/FireFire.png" };
		spellMap.emplace(SpellType::FIRE | SpellType::FIRE, pCombinedSpell);

		pCombinedSpell = new Magic::SpellData{ "Air + Air", "Spells/AirAir", COMBINED,  0.0f, 0.0f, "", 1.0f, glm::vec3(0.0f), "Resources/Textures/AirAir.png" };
		spellMap.emplace(SpellType::AIR | SpellType::AIR, pCombinedSpell);

		pCombinedSpell = new Magic::SpellData{ "Earth + Earth", "Spells/EarthEarth", COMBINED, 0.0f, 0.0f, "", 3.0f, glm::vec3(0.0f), "Resources/Textures/EarthEarth.png" };
		spellMap.emplace(SpellType::EARTH | SpellType::EARTH, pCombinedSpell);

		pCombinedSpell = new Magic::SpellData{ "Water + Water", "Spells/WaterWater", COMBINED, 0.0f, 0.0f, "", 1.0f, glm::vec3(0.0f), "Resources/Textures/WaterWater.png" };
		spellMap.emplace(SpellType::WATER | SpellType::WATER, pCombinedSpell);

		pCombinedSpell = new Magic::SpellData{ "Fire + Air", "Spells/FireAir", COMBINED,  0.0f, 0.0f, "", 0.1f, glm::vec3(0.0f), "Resources/Textures/FireAir.png" };
		spellMap.emplace(SpellType::FIRE | SpellType::AIR, pCombinedSpell);

		pCombinedSpell = new Magic::SpellData{ "Fire + Earth", "Spells/FireEarth", COMBINED, 0.0f, 0.0f, "", 5.0f, glm::vec3(0.0f), "Resources/Textures/FireEarth.png" };
		spellMap.emplace(SpellType::FIRE | SpellType::EARTH, pCombinedSpell);

		pCombinedSpell = new Magic::SpellData{ "Fire + Water", "Spells/FireWater", COMBINED, 0.0f, 0.0f, "", 1.0f, glm::vec3(0.0f), "Resources/Textures/FireWater.png" };
		spellMap.emplace(SpellType::FIRE | SpellType::WATER, pCombinedSpell);

		pCombinedSpell = new Magic::SpellData{ "Air + Earth", "Spells/AirEarth", COMBINED, 0.0f, 0.0f, "", 1.0f, glm::vec3(0.0f), "Resources/Textures/AirEarth.png" };
		spellMap.emplace(SpellType::AIR | SpellType::EARTH, pCombinedSpell);

		pCombinedSpell = new Magic::SpellData{ "Air + Water", "Spells/AirWater", COMBINED, 0.0f, 0.0f, "", 1.0f, glm::vec3(0.0f), "Resources/Textures/AirWater.png" };
		spellMap.emplace(SpellType::AIR | SpellType::WATER, pCombinedSpell);

		pCombinedSpell = new Magic::SpellData{ "Earth + Water", "Spells/EarthWater", COMBINED, 0.0f, 0.0f, "", 1.0f, glm::vec3(0.0f), "Resources/Textures/EarthWater.png" };
